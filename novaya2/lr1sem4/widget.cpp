...
void Widget::initializeGL()
{
    ...
    coneVertical = new Cone(33.0f, 82.0f);
    ddrawHorizontal = new ddraw(19.0f, 74.0f);
}
...
void Widget::paintGL()
{
    ...
    coneVertical->draw(-90, 90, 90,  -30.0f, 18.0f, -25.0f);

    ddrawHorizontal->draw(0, 0, 0,  0.0f, 20.0f, -60.0f);
